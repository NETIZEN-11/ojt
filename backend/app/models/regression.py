...
from app.domain.enums import Verdict, SeverityLevel, RegressionType
...
class Regression(Base):
    ...
    acknowledged_by: Mapped[Optional[PG_UUID]] = mapped_column(PG_UUID(as_uuid=True), ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
